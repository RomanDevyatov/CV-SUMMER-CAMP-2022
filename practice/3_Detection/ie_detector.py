...
sys.path.append(r'C:\Users\Roman_Devyatov\PROGRAMMING\PythonProjects\SummerUNN\open_model_zoo\demos\common\python')
...
def draw_detections(frame, detections, labels, threshold=0.5):
    for detection in detections:
        if detection.score > threshold:
            cv2.rectangle(frame, (detection.xmin, detection.ymin), (detection.xmax, detection.ymax), (0, 200, 200), 1)
